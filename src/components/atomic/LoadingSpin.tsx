...
export default function LoadingSvg({ size = 26 }: LoadingSvgProps) {
  return (
    <svg class="my-auto animate-spin fill-nord6" height={size} width={size} viewBox="0 -960 960 960" xmlns="http://www.w3.org/2000/svg">
